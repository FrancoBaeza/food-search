  ...
  return (
    <div className=" h-screen bg-selected_green flex flex-col gap-3 items-center justify-center">
      <p className="text-xl font-bold pl-4">
        <svg
          width="130.1111145019531"
          height="34.83783608022537"
      ...
      <div className="bg-slate-200 w-96 flex flex-col items-center gap-3 py-3 px-4 rounded">
        ...
        <button className=" w-1/3 bg-primary_green rounded-full">
          Sing In
        </button>
      </div>
    </div>
